...
describe( 'api', function() {
	...
	if ( ! config.isEnabled( 'oauth' ) ) {
		withOAuthIt = withOAuthIt.skip;
	}

	withOAuthIt( 'should handle incomplete login details', function( done ) {
	...
	withOAuthIt( 'should return a login error with a bad login', function( done ) {
		const end = sandbox.stub( request.Request.prototype, 'end' ),
	...
	withOAuthIt( 'should return a 400 needs_2fa if the user has 2FA enabled', function( done ) {
		const response = {
				error: 'needs_2fa',
	...
	withOAuthIt( 'should return a successful login', function( done ) {
	...
	withOAuthIt( 'should return a 408 with no connection', function( done ) {
		const response = {
	...
	withOAuthIt( 'should return a 400 push verification request if the server supports it', function( done ) {
		const response = {
				error: 'needs_2fa',
